...
const Select = ({
  taskStatus = {
    ...
    name: "All",
    selector: "All",
    icon: <div className="h-5 w-5 bg-inactive rounded-sm"></div>,
  },
  setTaskStatus,
}) => {
  const t = useTranslations("TaskStatus1");
  ...
  const [selected, setSelected] = React.useState(
    people.find((p) => p.selector === taskStatus.selector)
  );
  console.log("This Called ",taskStatus)
  useEffect(() => {
