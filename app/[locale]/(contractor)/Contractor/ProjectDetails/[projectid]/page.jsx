  ...
  const handleRightClick = () => {
   if(projects.length > 0) {
      if (index < projects.length - 1) {
        router.push(`/Contractor/ProjectDetails/${projects[index + 1].id}`);
      } else {
        router.push(`/Contractor/ProjectDetails/${projects[0].id}`);
      }
    }
  };
  ...
  const handleLeftClick = () => {
    if(projects.length > 0) {
      if (index > 0) {
        ...
        router.push(`/Contractor/ProjectDetails/${projects[projects.length - 1].id}`);
      }
    }
  };
